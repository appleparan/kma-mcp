...
async def get_aws_current_weather(station_id: int = 0) -> str:
    ...
    try:
        async with AsyncAWSClient(API_KEY) as client:
            ...
            data = await client.get_minutely_data(tm=current_minute, stn=station_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
async def get_aws_minutely_weather(
    ...
    try:
        async with AsyncAWSClient(API_KEY) as client:
            data = await client.get_minutely_period(tm1=start_time, tm2=end_time, stn=station_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
@mcp.tool()
async def get_aws_hourly_weather(
    start_time: str,
    end_time: str,
    station_id: int = 0,
) -> str:
...
@mcp.tool()
async def get_aws_daily_weather(
    start_date: str,
    end_date: str,
    station_id: int = 0,
) -> str:
...
@mcp.tool()
async def get_snow_current_depth(station_id: int = 0) -> str:
...
@mcp.tool()
async def get_snow_hourly_depth(
    start_time: str,
    end_time: str,
    station_id: int = 0,
) -> str:
...
@mcp.tool()
async def get_snow_daily_depth(
    start_date: str,
    end_date: str,
    station_id: int = 0,
) -> str:
...
# ============================================================================
# Weather Radar Tools - Async
# ============================================================================


@mcp.tool()
async def get_radar_image(observation_time: str, radar_id: str = 'ALL') -> str:
    ...
    try:
        async with AsyncRadarClient(API_KEY) as client:
            data = await client.get_radar_image(tm=observation_time, radar_id=radar_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
@mcp.tool()
async def get_radar_reflectivity_at_location(
    ...
    try:
        async with AsyncRadarClient(API_KEY) as client:
            data = await client.get_radar_reflectivity(tm=observation_time, x=longitude, y=latitude)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
# ============================================================================
# Typhoon Information Tools - Async
# ============================================================================


@mcp.tool()
async def get_current_typhoons() -> str:
    ...
    try:
        async with AsyncTyphoonClient(API_KEY) as client:
...
@mcp.tool()
async def get_typhoon_details(typhoon_id: str) -> str:
    ...
    try:
        async with AsyncTyphoonClient(API_KEY) as client:
            data = await client.get_typhoon_by_id(typhoon_id=typhoon_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
@mcp.tool()
async def get_typhoon_forecast_track(typhoon_id: str) -> str:
    ...
    try:
        async with AsyncTyphoonClient(API_KEY) as client:
            data = await client.get_typhoon_forecast(typhoon_id=typhoon_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
@mcp.tool()
async def get_typhoon_history_by_year(year: int) -> str:
    ...
    try:
        async with AsyncTyphoonClient(API_KEY) as client:
            data = await client.get_typhoon_history(year=year)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
# ============================================================================
# Marine Observation (Buoy) Tools - Async
# ============================================================================


@mcp.tool()
async def get_marine_buoy_data(observation_time: str, station_id: int = 0) -> str:
    ...
    try:
        async with AsyncBuoyClient(API_KEY) as client:
            data = await client.get_buoy_data(tm=observation_time, stn=station_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
@mcp.tool()
async def get_marine_buoy_period(start_time: str, end_time: str, station_id: int = 0) -> str:
    ...
    try:
        async with AsyncBuoyClient(API_KEY) as client:
            data = await client.get_buoy_period(tm1=start_time, tm2=end_time, stn=station_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
        return f'Error fetching marine buoy data: {e!s}'
...
# ============================================================================
# Upper-Air Observations (Radiosonde) Tools - Async
# ============================================================================


@mcp.tool()
async def get_upper_air_data(
...
async def get_atmospheric_stability_indices(
    ...
    try:
        async with AsyncRadiosondeClient(API_KEY) as client:
            data = await client.get_stability_indices(tm1=start_time, tm2=end_time, stn=station_id)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
# ============================================================================
# Earthquake Monitoring Tools - Async
# ============================================================================


@mcp.tool()
async def get_recent_earthquake_info() -> str:
    ...
    try:
        async with AsyncEarthquakeClient(API_KEY) as client:
...
@mcp.tool()
async def get_earthquake_list(start_time: str, end_time: str) -> str:
    ...
    try:
        async with AsyncEarthquakeClient(API_KEY) as client:
            data = await client.get_earthquake_list(tm1=start_time, tm2=end_time)
            return str(data)
    except Exception as e:  # noqa: BLE001
...
async def get_satellite_file_list(
    ...
    try:
        async with AsyncSatelliteClient(API_KEY) as client:
            data = await client.get_satellite_file_list(
