...
export class AWSClient extends BaseKMAClient {
  ...
  /**
   * @deprecated Use getMinutelyData() with tm1 and tm2 parameters instead.
   * WARNING: This endpoint (kma_aws2.php) is not documented in the official API.
   *
   * Get minutely AWS observation data for a time period (undocumented endpoint)
   */
  ...
  /**
   * @deprecated This endpoint (kma_aws3.php) is not documented in the official API.
   * Consider using getMinutelyData() with the documented nph-aws2_min endpoint.
   *
   * Get hourly AWS observation data for a single time (undocumented endpoint)
   */
  ...
  /**
   * @deprecated This endpoint (kma_aws4.php) is not documented in the official API.
   * Consider using getMinutelyData() with the documented nph-aws2_min endpoint.
   *
   * Get hourly AWS observation data for a time period (undocumented endpoint)
   */
  ...
  /**
   * @deprecated This endpoint (kma_aws5.php) is not documented in the official API.
   *
   * Get daily AWS observation data for a single day (undocumented endpoint)
   */
  ...
  /**
   * @deprecated This endpoint (kma_aws6.php) is not documented in the official API.
   *
   * Get daily AWS observation data for a date range (undocumented endpoint)
   */
